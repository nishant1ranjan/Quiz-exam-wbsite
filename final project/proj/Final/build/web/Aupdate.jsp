...
<%
	...
	String sql="select *  from admindata where email='"+ema+"'";
	...
	if(request.getParameter("btn_update")!=null)
	{
		Class.forName("org.sqlite.JDBC");
                ...
                Connection conn = DriverManager.getConnection("jdbc:sqlite:C://Users//Nishant//Desktop//proj//mnnit.sqlite");
		...
		String sq="update admindata set id='"+idd+"',adminname='"+name+"',email='"+email+"',uname='"+uname+"',pass='"+pass+"',City='"+city+"',State='"+state+"' where email='"+email+"'";
