...
<%
    ...
    //ResultSet rs;
    int i = st.executeUpdate("insert into Level1(qno,question,option1,option2,option3,option4,answer,ans,subject) values ('" + qno + "','" + question + "','" + option1 + "','" + option2 + "','" + option3 + "','" + option4 + "',"
            + "'" + answer + "','" + ans + "','" + subject + "')");
    if (i > 0) {
