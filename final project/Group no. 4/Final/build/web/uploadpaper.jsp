...
<html>
	...
	<script src= "js/bootstrap.min.js"></script> 
     ...
     <body onload="f1()" >
      <div class = "container"> 
          <form name= myForm id="myForm" method="post" action="ans.jsp" >
...
<%
    ...
    try {
      ...
      con = DriverManager.getConnection("jdbc:sqlite:F://project//final project//proj//mnnit.sqlite");
     ...
     // out.println("<form action=ansurl name=ans method=get>");
      ...
      while (resultSet.next()) {
        ...
        int k = resultSet.getInt(1);
                    ...
                    out.println("<td align=justify><input type=radio name=opt" + j + " value=1 /><b>" + resultSet.getString(3) +
                   "</b> &nbsp;&nbsp;<br><br></td>");
                    out.println("</tr>");
                    
                    out.println("<tr>");
                    out.println("<td align=center></td>");
                    out.println("<td align=justify><input type=radio name=opt" + j + " value=1 /><b>" + resultSet.getString(4) +
                   "</b> &nbsp;&nbsp;<br><br></td>");
                    out.println("</tr>");
                    
                    out.println("<tr>");
                    out.println("<td align=center></td>");
                    out.println("<td align=justify><input type=radio name=opt" + j + " value=1 /)<b>" + resultSet.getString(5) +
                   "</b> &nbsp;&nbsp;<br><br></td>");
                    out.println("</tr>");
                    
                    out.println("<tr>");
                    out.println("<td align=center></td>");
                    out.println("<td align=justify><input type=radio name=opt" + j + " value=1 /><b>" + resultSet.getString(6) +
                   "</b> &nbsp;&nbsp;<br><br></td>");
                    out.println("</tr>");
